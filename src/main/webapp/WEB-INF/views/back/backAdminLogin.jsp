...
<div class="content">
    ...
    <div class="content-form">
        <form method="post" action="<%=basepath%>backAdminIndex.action" onsubmit="return submitTest()" >
            <div id="change_margin_1">
                <span class="icon"><i class="Hui-iconfont">&#xe60d;</i></span>
                <input class="text" type="text" name="adminid" autocomplete="off" placeholder="请输入用户ID" reqired onblur="oBlur_1()" onfocus="oFocus_1() ">
            </div>
            <!-- input的value为空时弹出提醒 -->
            <p id="remind_1"></p>
            <div id="change_margin_2">
                <span class="icon"><i class="Hui-iconfont">&#xe60e;</i></span>
                <input class="password" type="password" name="adminpass" autocomplete="off" placeholder="请输入密码" reqired onblur="oBlur_2()" onfocus="oFocus_2()">
            </div>
